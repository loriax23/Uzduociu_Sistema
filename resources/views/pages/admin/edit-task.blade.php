            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('edit-task-action', $data->id) }}">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="task_name" type="text"
                                               ...
                                               name="task_name" placeholder="Pavedžioti Šunis"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="assigned_to" type="text"
                                               ...
                                               name="assigned_to" placeholder="Jonas" value="{{ $data->assigned_to }}"
                                ...
                                <div class="form-group row">
                                    <label for="due_to" class="col-md-4 col-form-label text-md-right">Atlikti
                                        Iki</label>

                                    <div class="col-md-6">
                                        <input id="due_to" type="text"
                                               class="form-control @error('due_to') is-invalid @enderror" name="due_to"
                                               placeholder="MMMM/MM/DD" value="{{ $data->due_to }}"
